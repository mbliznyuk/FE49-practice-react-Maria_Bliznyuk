...
import { LeftWrapperForBigCard, LeftWrapperForMiddleCard, LeftWrapperOfPosts, ListOfPostsWrapper, RightWrapperOfPosts } from "./list-of-posts.style";
...
export const ListOfPosts: React.FC<ListOfPostsProps> = (props:ListOfPostsProps) => {
return <ListOfPostsWrapper>
    <LeftWrapperOfPosts>
